...
The other is to estimate the parameters for Gaussian Mixtures with 2 components using EM algorithm, called _myEM_. Besides, a function _mydis_ to measure the distance between two models is proposed as well.
